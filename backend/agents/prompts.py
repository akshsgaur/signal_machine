...
[Key quantitative signals, confidence level]

### Support (Zendesk)
[Key qualitative signals, confidence level]

### Feature Demand (Productboard)
[Key demand signals, confidence level]
...
## Risk Flags
[Any red flags or missing data that should inform the decision]
